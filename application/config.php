...
return [
    ...
    //秒杀商品redis相关的key
    'seckill' => [
        'ids'  => 'sk_goods_ids',               //秒杀商品godos_id集合key
        'info' => 'sk_goods_info_',             //单个秒杀商品信息存储key
        'num'  => 'sk_goods_num_',              //单个秒杀商品的数量存储key
        'byuser' => 'sk_goods_by_users_',       //记录商品被哪些用户所秒杀到
    ],
    ...
    'mail'=>[
        ...
        'addr'            => 'chuanzhi118@sina.com', // 发件邮箱地址(邮箱帐号名称)
        'pass'            => 'sina0118', // 发件邮箱密码(帐号密码)
        'name'            => '品优购-php68', // 发件邮箱名称(昵称)
        ...
        'log_path'        => '../runtime/tp_mailer', // 日志路径, 可选, 不配置日志驱动时启用默认日志驱动, 默认路径是 /path/to/tp-mailer/log, 要保证该目录有可写权限, 最好配置自己的日志路径
        'embed'           => 'embed:', // 邮件中嵌入图片元数据标记
    ],


    //给3种特殊营销商品定义redis应用的key名称
    'special_goods'=>[
        'new'   =>  'goods_new',
        'pro'   =>  'goods_pro',
        'hot'   =>  'goods_hot',
